...
Not yet built: nothing outstanding from the original scope — remaining work is deployment (where this actually runs in production, see the Cloudways discussion) and any further product decisions beyond what's listed above.
